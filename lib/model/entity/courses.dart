...
class Courses extends Equatable {
  ...
  @override
  String toString() {
    return 'Category{id: $id, name: $name, image: $image, intro: $intro,content:$content,slug:$slug,multiCat:$multiCat,basePrice:$basePrice,finalPrice:$finalPrice,status:$status,createdAt:$createdAt,updatedAt:$updatedAt,time:$time,metaTitle:$metaTitle,metaDescription:$metaDescription,companyId:$companyId,categoryId:$categoryId,orderNo:$orderNo,menuId:$menuId,type:$type,level:$level,utilities:$utilities,dateOfPossession:$dateOfPossession,certificate:$certificate,tags:$tags,document:$document,lecturer:$lecturer,category:$category}';
  }
}
